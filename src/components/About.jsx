...
// Gets number of full years since my start date at Amazon minus 3 months to include internship (2023-06-11)
// Date().getMonth() returns zero-indexed month
const experienceYears =
  new Date().getFullYear() -
  2023 -
  (new Date().getMonth() < 5 ||
  (new Date().getMonth() === 5 && new Date().getDate() < 11)
    ? 1
    : 0);
const aboutItems = [
  {
